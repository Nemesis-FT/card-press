...
export default function SpellDetails(props) {
    ...
    return (
        <Panel style={{"marginTop": "0px"}}>
            ...
            <p style={{"marginBottom":"0px"}}><b>Casting time: </b>{(item.time !== undefined) ? castingPrettify(item) : "No casting time"}</p>
            <p style={{"marginBottom":"0px"}}><b>Range: {(item.range !== undefined) ? rangePrettify(item.range) : "No range time"}</b></p>
            <p style={{"marginBottom":"0px"}}><b>Components: {(item.components !== undefined) ? componentsPrettify(item.components):"No components"}</b></p>
            <p style={{"marginBottom":"0px"}}><b>Duration: {(item.duration !== undefined) ? durationPrettify(item.duration) :  "No duration"}</b></p>
            <hr/>
